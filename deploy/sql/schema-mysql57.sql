-- kubeconfig-ui MySQL 5.7 schema (structure only, no data)
-- Compatible with MySQL 5.7.x (utf8mb4 / utf8mb4_general_ci).
-- Usage:
...
CREATE DATABASE IF NOT EXISTS `kubeconfig_ui`
